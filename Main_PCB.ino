...
//pins being used: green - 9; yellow - 8; servo - 12; red - 13; buzzer - 23; keypad - 4:11; pressure - A15; reserve - A3; lock/unlock - A14

int green = 9;
int yellow = 8;
int servoPin = 12;  //brown = ground; middle = 5V; orange = pin
int red = 13;
int buzzerPin = 23;
int pressurePin = A15;
int reservePin = A3;
...
const int rs = 22, en = 24, d4 = 1, d5 = 3, d6 = 5, d7 = 7;
...
//Opening Locker
  ...
  else if (openSignal < 100 && reserved == 2){
    lockerOpen = 0;
    closeLocker();
    unreserveTimer = 0;
    unreserveFlag = 0;
